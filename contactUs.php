  ...
  <aside class="sidebar">
    <div class="sidebar-card">
      ...
      <a href="aboutUs.php">
        ...
        <button class="menu-btn active" type="button" data-target="contact" >
          <span class="icon" aria-hidden="true">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
  ...
  <main class="app main">
    <div class="container">
      ...
      <section class="section" id="home">
        ...
        <div style="width:90%; padding-right:20%">
        <div style=" width: 90%;">
          <div class="card" style="padding: 10%; align-items: center;">
          <h2>ارسال نظر</h2>
          <p style="line-height:2; opacity:.8; margin-bottom:20px;">
              از طریق این بخش می‌توانید پیشنهادات، انتقادات و گزارش مشکلات
              مربوط به سامانه را برای مدیر ارسال کنید.
              لطفاً نظر خود را به صورت کامل و واضح ثبت نمایید.
          </p>

          <?php if($message!=''): ?>
              <div class="alert <?php echo $messageType=='success' ? 'success' : 'danger'; ?>">
                  <span class="mark">
    ...
    <form method="post">
        <textarea class="input" name="content" rows="10" placeholder="نظر خود را اینجا بنویسید..." required
            style=" resize:none; min-height:260px;" >
        </textarea>

        <div style="height:20px;"></div>

        <button class="btn"type="submit" style="margin-right: 40%">ثبت نظر
        </button>
    </form>
