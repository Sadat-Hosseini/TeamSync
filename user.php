  ...
  <aside class="sidebar">
    <div class="sidebar-card">
      ...
      <nav class="nav">
        ...
        <button class="menu-btn active" type="button" data-target="profile" id="btnuser">
          <span class="icon" aria-hidden="true">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                 xmlns="http://www.w3.org/2000/svg">
...
<?php echo $editProject ? 'ویرایش پروژه' : 'ایجاد پروژه جدید'; ?>
...
required><?php echo $editProject['description'] ?? ''; ?></textarea>
...
<input class="input" type="date" name="end_date" value="<?php echo $editProject['end_date'] ?? ''; ?>">
...
<h2>پروژه های ساخته شده توسط من</h2>
